...
public class GlobalException extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorReponseDto> CardAlreadyExistException(
            CardAlreadyExistException exception,WebRequest request) {
        {
    ...
    public ResponseEntity<ErrorReponseDto> ResourceNotFoundException(
    ...
    public ResponseEntity<ErrorReponseDto> handlerException(Exception ex, WebRequest request) {
        ErrorReponseDto errorReponseDto = new ErrorReponseDto(
                request.getDescription(false),
